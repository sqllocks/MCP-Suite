...
const SERVER_NAME = 'mcp-frequency-tracking';
const TOOL_NAME = 'track_frequency';
const DESCRIPTION = 'Track term and pattern frequency';
class FrequencyTrackingServer {
    constructor() {
...
const server = new FrequencyTrackingServer();
server.start();
export default FrequencyTrackingServer;

...
const SERVER_NAME = 'mcp-docs-rag';
const TOOL_NAME = 'query_docs';
const DESCRIPTION = 'Query documentation using RAG';
class DocsRagServer {
    constructor() {
...
const server = new DocsRagServer();
server.start();
export default DocsRagServer;

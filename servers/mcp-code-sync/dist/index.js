...
const SERVER_NAME = 'mcp-code-sync';
const TOOL_NAME = 'sync_code';
const DESCRIPTION = 'Synchronize code across repositories';
...
const server = new CodeSyncServer();
server.start();
export default CodeSyncServer;

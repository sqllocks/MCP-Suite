...
const SERVER_NAME = 'mcp-microsoft-docs';
const TOOL_NAME = 'search_ms_docs';
const DESCRIPTION = 'Search Microsoft documentation';

class MicrosoftDocsServer {
...
const server = new MicrosoftDocsServer();
server.start();

export default MicrosoftDocsServer;

...
const SERVER_NAME = 'humanizer-mcp';
const TOOL_NAME = 'humanize_text';
const DESCRIPTION = 'Humanize AI-generated text';

class HumanizerServer {
...
const server = new HumanizerServer();
server.start();

export default HumanizerServer;

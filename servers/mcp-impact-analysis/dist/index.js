...
const SERVER_NAME = 'mcp-impact-analysis';
const TOOL_NAME = 'analyze_impact';
const DESCRIPTION = 'Analyze code change impact';
class ImpactAnalysisServer {
    constructor() {
...
const server = new ImpactAnalysisServer();
server.start();
export default ImpactAnalysisServer;

...
const SERVER_NAME = 'mcp-stream-processor';
const TOOL_NAME = 'process_stream';
const DESCRIPTION = 'Process data streams';
class StreamProcessorServer {
    constructor() {
...
const server = new StreamProcessorServer();
server.start();
export default StreamProcessorServer;

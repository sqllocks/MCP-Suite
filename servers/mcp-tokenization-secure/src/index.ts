...
const SERVER_NAME = 'mcp-tokenization-secure';
const TOOL_NAME = 'secure_tokenize';
const DESCRIPTION = 'Secure tokenization and detokenization';

class TokenizationSecureServer {
...
const server = new TokenizationSecureServer();
server.start();

export default TokenizationSecureServer;

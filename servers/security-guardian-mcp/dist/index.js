...
const SERVER_NAME = 'security-guardian-mcp';
const TOOL_NAME = 'check_security';
const DESCRIPTION = 'Security analysis and recommendations';
class SecurityGuardianServer {
    constructor() {
...
const server = new SecurityGuardianServer();
server.start();
export default SecurityGuardianServer;

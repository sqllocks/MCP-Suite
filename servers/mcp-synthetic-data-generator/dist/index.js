...
const SERVER_NAME = 'mcp-synthetic-data-generator';
const TOOL_NAME = 'generate_synthetic_data';
const DESCRIPTION = 'Generate synthetic test data';
class SyntheticDataGeneratorServer {
    constructor() {
...
const server = new SyntheticDataGeneratorServer();
server.start();
export default SyntheticDataGeneratorServer;

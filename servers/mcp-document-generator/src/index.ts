...
const SERVER_NAME = 'mcp-document-generator';
const TOOL_NAME = 'generate_document';
const DESCRIPTION = 'Generate structured documents';
...
export default DocumentGeneratorServer;

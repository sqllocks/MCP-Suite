...
const SERVER_NAME = 'mcp-diagram-generator';
const TOOL_NAME = 'generate_diagram';
const DESCRIPTION = 'Generate diagrams from descriptions';
...
const server = new DiagramGeneratorServer();
server.start();

export default DiagramGeneratorServer;

...
const SERVER_NAME = 'mcp-fabric-live';
const TOOL_NAME = 'fabric_live';
const DESCRIPTION = 'Live fabric pattern processing';
...
const server = new FabricLiveServer();
server.start();

export default FabricLiveServer;

...
class SQLExplorerServer {
    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(ListToolsRequestSchema, async () => {
            return {
                tools: [
                    createToolDefinition('generate_sql', 'Generate SQL query from natural language description', {
                        description: {
                            type: 'string',
                    ...
                    createToolDefinition('query_sql', 'Analyze SQL query and provide insights, optimization suggestions', {
                        query: {
                            type: 'string',
                    ...
                    createToolDefinition('explain_sql', 'Explain what a SQL query does in simple terms', {
                        sql: {
                            type: 'string',
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            switch (name) {
                ...
                case 'query_sql':
                    return await this.handleQuerySQL(args);
                case 'explain_sql':
                    return await this.handleExplainSQL(args);
                default:

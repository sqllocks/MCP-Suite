...
const SERVER_NAME = 'auto-remediation';
const TOOL_NAME = 'auto_remediate';
const DESCRIPTION = 'Automatic code and configuration remediation';
class AutoRemediationServer {
    constructor() {
...
const server = new AutoRemediationServer();
server.start();
export default AutoRemediationServer;

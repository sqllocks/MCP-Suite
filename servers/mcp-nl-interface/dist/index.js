...
const SERVER_NAME = 'mcp-nl-interface';
const TOOL_NAME = 'natural_language';
const DESCRIPTION = 'Natural language interface';
class NaturalLanguageServer {
    constructor() {
...
const server = new NaturalLanguageServer();
server.start();
export default NaturalLanguageServer;
